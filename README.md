...
https://qa108.yonote.ru/collection/finalnyj-proekt-po-ruchnomu-testirovaniyu-LvI34ikSta
...
## Установка
1. Клонируйте репозиторий: git clone https://github.com/Oxana1204/Python_Final.git
...
pages/ — содержит файлы с объявленными классами, необходимыми для тестирования.
...
## Запуск тестов 
pytest Python_Final -s -v (запуск всех тестов)

pytest Python_Final/Python_Final/tests/test_ui.py (запуск только UI тестов) 

pytest Python_Final/Python_Final/tests/test_api.py (запуск только API тестов) 

pytest Python_Final --alluredir=allure-files (запустить тесты с Allure)
